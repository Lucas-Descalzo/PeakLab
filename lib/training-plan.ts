...
export function buildPlan(): PlannedWorkout[] {
  ...
  const weeks: Array<{
    ...
    {
      week: 1, phase: 1,
      tue: { date: '', week: 1, phase: PHASES[1], type: 'easy', title: 'Fácil Z2', description: 'Test de control de intensidad. Si podés hablar sin esfuerzo, vas bien.', distanceKm: 8, paceTarget: '5:55-6:15/km', hrTarget: 'HR < 140', details: '8km continuos a Z2. Si te salís de HR 140, bajá el ritmo aunque parezca muy lento.' },
      ...
      sun: { date: '', week: 1, phase: PHASES[1], type: 'long', title: 'Long Run 13km', description: 'Ritmo conversacional todo el tiempo.', distanceKm: 13, paceTarget: '6:05-6:20/km', hrTarget: 'HR < 140', details: '13km Z2. Si querés, el último km un poco más rápido (~6:15/km) si te sentís bien.' },
    },
    {
      week: 2, phase: 1,
      tue: { date: '', week: 2, phase: PHASES[1], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 9, paceTarget: '5:55-6:15/km', hrTarget: 'HR < 140', details: '9km Z2 continuo.' },
      ...
      sun: { date: '', week: 2, phase: PHASES[1], type: 'long', title: 'Long Run 15km', description: '', distanceKm: 15, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '15km Z2.' },
    },
    {
      week: 3, phase: 1,
      tue: { date: '', week: 3, phase: PHASES[1], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 9, paceTarget: '5:55-6:15/km', hrTarget: 'HR < 140', details: '9km Z2.' },
      ...
      sun: { date: '', week: 3, phase: PHASES[1], type: 'long', title: 'Long Run 16km', description: '', distanceKm: 16, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '16km Z2. Último km a ~6:15 si te sentís bien.' },
    },
    {
      week: 4, phase: 1,
      tue: { date: '', week: 4, phase: PHASES[1], type: 'easy', title: 'Fácil Z2', description: 'Semana de descarga.', distanceKm: 7, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '7km Z2, muy relajado.' },
      ...
      sun: { date: '', week: 4, phase: PHASES[1], type: 'long', title: 'Long Run 12km', description: '', distanceKm: 12, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '12km Z2.' },
    },
    // FASE 2 — BUILD
    {
      week: 5, phase: 2,
      tue: { date: '', week: 5, phase: PHASES[2], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 10, paceTarget: '5:55-6:15/km', hrTarget: 'HR < 140', details: '10km Z2.' },
    ...
    },
    {
      ...
      thu: { date: '', week: 7, phase: PHASES[2], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 11, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '11km Z2.' },
    ...
    {
      week: 8, phase: 2,
      tue: { date: '', week: 8, phase: PHASES[2], type: 'easy', title: 'Fácil Z2', description: 'Semana de descarga.', distanceKm: 8, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '8km Z2.' },
      ...
      sun: { date: '', week: 8, phase: PHASES[2], type: 'long', title: 'Long Run 14km', description: '', distanceKm: 14, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '14km Z2.' },
    },
    // FASE 3 — TAPER MEDIA
    {
      week: 9, phase: 3,
      tue: { date: '', week: 9, phase: PHASES[3], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 8, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '8km Z2.' },
      ...
      sun: { date: '', week: 9, phase: PHASES[3], type: 'long', title: 'Long Run 15km', description: '', distanceKm: 15, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '15km Z2.' },
    },
    {
      week: 10, phase: 3,
      tue: { date: '', week: 10, phase: PHASES[3], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 5, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '5km Z2.' },
      ...
      sun: { date: '', week: 10, phase: PHASES[3], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 8, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '8km Z2.' },
    },
    {
      week: 11, phase: 3,
      tue: { date: '', week: 11, phase: PHASES[3], type: 'easy', title: 'Fácil Z2', description: 'Semana de carrera. Solo activaciones.', distanceKm: 5, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '5km Z2, muy suave.' },
    ...
    // FASE 4 — RECOVERY + BUILD MARATÓN
    {
      ...
      thu: { date: '', week: 12, phase: PHASES[4], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 7, paceTarget: '6:05-6:20/km', hrTarget: 'HR < 140', details: '7km Z2 si te sentís bien. Reducir a 5km si hay fatiga.' },
      sun: { date: '', week: 12, phase: PHASES[4], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 10, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '10km Z2.' },
    },
    {
      week: 13, phase: 4,
      tue: { date: '', week: 13, phase: PHASES[4], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 8, paceTarget: '5:55-6:15/km', hrTarget: 'HR < 140', details: '8km Z2.' },
    ...
    {
      week: 14, phase: 4,
      tue: { date: '', week: 14, phase: PHASES[4], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 8, paceTarget: '5:55-6:15/km', hrTarget: 'HR < 140', details: '8km Z2.' },
    ...
    {
      week: 15, phase: 5,
      tue: { date: '', week: 15, phase: PHASES[5], type: 'easy', title: 'Fácil Z2', description: '', distanceKm: 5, paceTarget: '6:00-6:20/km', hrTarget: 'HR < 140', details: '5km Z2.' },
